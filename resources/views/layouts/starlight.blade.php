...
<html lang="en">
  <head>
    ...
    <title>Library of Friendship- @yield('title')</title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>Library of Friendship
    </a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link @yield('author')">
          <div class="sl-menu-item">
           <i class="fa-solid fa-align-left"></i>
            <span class="menu-item-label">Author Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/author')}}" class="nav-link">Add Author</a></li>
          </ul>
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link @yield('publisher')">
          <div class="sl-menu-item">
           <i class="fa-solid fa-align-left"></i>
            <span class="menu-item-label">Publisher Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
          <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/publisher')}}" class="nav-link">Add Publisher</a></li>
          </ul>
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link @yield('book')">
          <div class="sl-menu-item">
            <i class="fa-solid fa-align-left"></i>
            <span class="menu-item-label">Book Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/book')}}" class="nav-link">Add Book</a></li>
           </ul>
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link @yield('issue')">
          <div class="sl-menu-item">
           <i class="fa-solid fa-align-left"></i>
            <span class="menu-item-label">Book Issue Info</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
          <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/issue')}}" class="nav-link">Add Book Issue</a></li>
          </ul>
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link @yield('authority')">
          <div class="sl-menu-item">
            <i class="fa-solid fa-align-left"></i>
            <span class="menu-item-label">Management Details</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/authority')}}" class="nav-link">Add Management</a></li>
           </ul>
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link @yield('student')">
          <div class="sl-menu-item">
          <i class="fa-solid fa-align-left"></i>
            <span class="menu-item-label">Student Registration</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
           <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{url('/student')}}" class="nav-link">Add Student</a></li>
        </ul>
        </a><!-- sl-menu-link -->
      ...
      <div class="tab-content">
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
          <div class="media-list">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="{{asset('dashboard_assets/img/img4.jpg')}}" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="{{asset('dashboard_assets/img/img7.jpg')}}" class="wd-40 rounded-circle" alt="">
                <div class="media-body">
